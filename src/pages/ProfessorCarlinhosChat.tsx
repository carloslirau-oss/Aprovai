  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const botMessage: ChatMessage = {
        ...
        content: responseData.response || 'Obrigado pela sua mensagem! Recebi sua dúvida e estou analisando. Em breve retornarei com uma resposta detalhada para te ajudar com sua redação.
<dyad-write path="src/pages/ProfessorCarlinhosChat.tsx" description="Atualizando o webhook para o novo endereço">
"use client";
